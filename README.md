...
[![Crates.io](https://img.shields.io/crates/v/my-rust-template.svg)](https://crates.io/crates/rust-ci-cd-template)
[![Minimum Supported Rust Version](https://img.shields.io/badge/MSRV-1.59.0+-red.svg)](./Cargo.toml#L8)
[![CI](https://github.com/ameknite/my-rust-template/actions/workflows/ci.yaml/badge.svg)](https://github.com/ameknite/my-rust-template/actions?workflow=CI)
